    ...
    return (
        <div className="importanceContainer">
            ...
            <div className="importanceOptions">
                <motion.div whileHover={{scale: 1.2}}><Button id="greatsoundtrack" onClick={handleClick} style={{backgroundColor: "#FB6107"}} variant="contained">Great Soundtrack</Button></motion.div>
                ...
                <motion.div whileHover={{scale: 1.2}}><Button id="fullcontrollersupport" onClick={handleClick} style={{backgroundColor: "#7CB518"}} variant="contained">Controller support</Button></motion.div>
            </div>
